...
@Component({
  selector: 'app-demande-carburant',
  templateUrl: './demande-carburant.component.html',
  styleUrls: ['./demande-carburant.component.scss'],
  animations: [
...
export class DemandeCarburantComponent implements OnInit {
 /*/////DELETE CONFIRMATION///////*/
...
listeEnergie: any = [];
listeModele: any = [];
displayedColumns: string[] = ['number','datecreation','DirectionDemandeuse','activité','NbLitre','objet','Datedebut', 'action'];
