...
@Component({
  selector: 'app-demande-vehicule',
  templateUrl: './demande-vehicule.component.html',
  styleUrls: ['./demande-vehicule.component.scss'],
  animations: [
...
listeEnergie: any = [];
listeModele: any = [];
displayedColumns: string[] = ['number','datecreation','DirectionDemandeuse','activité','objet','Datedebut','Datefin', 'action'];
