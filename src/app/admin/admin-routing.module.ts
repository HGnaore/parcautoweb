...
import { TypeEntretienComponent } from "./referentiels/structure/type-entretien/type-entretien.component";
import { GaragesComponent } from "./referentiels/structure/garages/garages.component";
import { EntretienFiltreComponent } from "./referentiels/structure/entretien-filtre/entretien-filtre.component";
import { PieceComponent } from "./referentiels/structure/piece/piece.component";
...
const routes: Routes = [
  { path: "", redirectTo: "admin", pathMatch: "full" },
  {
    ...
    children: [
      ...
      {
        path: "validvehiculeList",
        component: ValidationVehiculeComponent,
        canActivate: [AuthGuard],
      },
      {
        path: "vehiculeEdition/:id/:ProfilID",
        component: VehiculeEditionComponent,
        canActivate: [AuthGuard],
      },
      {
        path: "locationList",
        component: LocationListeComponent,
        canActivate: [AuthGuard],
      },
      {
        path: "locationEdition/:id",
        component: LocationEditionComponent,
        canActivate: [AuthGuard],
      },

      {
        path: "entretienList",
        component: EntretienListeComponent,
        canActivate: [AuthGuard],
      },

      /* { path: 'entretienEdition/:id', component: EntretienEditionComponent, canActivate: [AuthGuard] },*/
      {
        path: "entretienProgramList",
        component: EntretienProgramListeComponent,
        canActivate: [AuthGuard],
      },
      {
        path: "entretienProgramEdition/:id",
        component: EntretienProgramEditionComponent,
        canActivate: [AuthGuard],
      },
      ...
      {
        path: "directionEdition/:id",
        component: DirectionEditionComponent,
        canActivate: [AuthGuard],
      },
      {
        path: "energiList",
        component: EnergiListeComponent,
        canActivate: [AuthGuard],
      },
      {
        path: "energiEdition/:id",
        component: EnergiEditionComponent,
        canActivate: [AuthGuard],
      },
      {
        path: "typefournisseurList",
        component: TypefournisseurListeComponent,
        canActivate: [AuthGuard],
      },
      {
        path: "typefournisseurEdition/:id",
        component: TypefournisseurEditionComponent,
        canActivate: [AuthGuard],
      },
      {
      ...
      ///////////TRAITEMENT//////////
      {
        path: "vehiculeInfo/:id/:ProfilID",
        component: InfovehiculeEditionComponent,
        canActivate: [AuthGuard],
      },
      {
        path: "vehiculeCardGrise/:id/:ProfilID",
        component: CartegriseEditionComponent,
        canActivate: [AuthGuard],
      },
      {
        path: "vehiculeVisiteVign/:id/:ProfilID",
        component: VisitetechniqueEditionComponent,
        canActivate: [AuthGuard],
      },
      {
        path: "vehiculeAssurance/:id/:ProfilID",
        component: AssurenceEditionComponent,
        canActivate: [AuthGuard],
      },
      {
        path: "vehiculeEntretien/:id/:ProfilID",
        component: EntretienEditionComponent,
        canActivate: [AuthGuard],
      },
      {
        path: "vehiculePanneReparation/:id/:ProfilID",
        component: PannereparationEditionComponent,
        canActivate: [AuthGuard],
      },
      {
        path: "vehiculeAccident/:id/:ProfilID",
        component: AccidentEditionComponent,
        canActivate: [AuthGuard],
      },

      ///////////PARC AUTO//////////
      {
        path: "parcauto/consultVehicule/:id/:ProfilID",
        component: ConsultationVehiculeComponent,
        canActivate: [AuthGuard],
      },
      {
        path: "parcauto/modifVehicule/:id/:ProfilID",
        component: ModificationVehiculeComponent,
        canActivate: [AuthGuard],
      },
      {
        path: "parcauto/traitemVehicule/:id/:ProfilID",
        component: TraitementVehiculeComponent,
        canActivate: [AuthGuard],
      },

      {
        path: "parcauto/demandeVehicule/:id",
        component: DemandeVehiculeComponent,
        canActivate: [AuthGuard],
      },
      {
        path: "parcauto/createDemandeVehicule/:id",
        component: CreateDemandeVehiculeComponent,
        canActivate: [AuthGuard],
      },

      {
        path: "parcauto/cuvreCarburant/:id",
        component: ListCarburantComponent,
        canActivate: [AuthGuard],
      },
      {
        path: "parcauto/cuvreDotationCarburant/:id",
        component: DotationCarburantComponent,
        canActivate: [AuthGuard],
      },
      {
        path: "parcauto/cuvreDemandeCarburant/:id",
        component: DemandeCarburantComponent,
        canActivate: [AuthGuard],
      },

      {
        path: "parcauto/carteCarburant/:id",
        component: CarteCarburantComponent,
        canActivate: [AuthGuard],
      },
      {
        path: "parcauto/carteFer/:id",
        component: CarteFerComponent,
        canActivate: [AuthGuard],
      },
      {
        path: "parcauto/approvionnercartecaburant/:id",
        component: ApprovisionnerCarteComponent,
        canActivate: [AuthGuard],
      },
      ...
      /////////REFERENTIEL////////////
      {
        path: "marqueList/:ProfilID",
        component: MarqueModeleListeComponent,
        canActivate: [AuthGuard],
      },
      {
        path: "marqueEdition/:ProfilID",
        component: MarqueModeleEditionComponent,
        canActivate: [AuthGuard],
      },
      {
        path: "energieList/:ProfilID",
        component: EnergieListeComponent,
        canActivate: [AuthGuard],
      },
      {
        path: "usageList/:ProfilID",
        component: UsageListeComponent,
        canActivate: [AuthGuard],
      },
      {
        path: "assureurList/:ProfilID",
        component: AssureurListeComponent,
        canActivate: [AuthGuard],
      },
      {
        path: "fonctionList/:ProfilID",
        component: FonctionVehiculeListeComponent,
        canActivate: [AuthGuard],
      },
      {
        path: "workflowList/:ProfilID",
        component: WorkflowListeComponent,
        canActivate: [AuthGuard],
      },
      {
        path: "workflowList/:ProfilID",
      ...
      {
        path: "param/profilList/:ProfilID",
        component: ProfilComponent,
        canActivate: [AuthGuard],
      },
      {
        path: "param/userList/:ProfilID",
        component: UtilisateurComponent,
        canActivate: [AuthGuard],
      },

      {
        path: "structure/garages",
        component: GaragesComponent,
        canActivate: [AuthGuard],
      },
      {
        path: "structure/type-entretien",
        component: TypeEntretienComponent,
        canActivate: [AuthGuard],
      },
      {
        path: "structure/entretien-filtre",
        component: EntretienFiltreComponent,
        canActivate: [AuthGuard],
      },
      {
        path: "structure/piece",
